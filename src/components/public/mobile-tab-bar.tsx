...
export function MobileTabBar() {
  ...
  return (
    ...
    // Marsala mais escuro que o --primary padrão (mesmo tom do header e
    // do botão de WhatsApp), a pedido da cliente.
    <nav className="fixed inset-x-0 bottom-0 z-40 flex h-16 items-center border-t border-white/10 bg-[#4a0c1c] md:hidden">
      {TABS.map((tab) => {
