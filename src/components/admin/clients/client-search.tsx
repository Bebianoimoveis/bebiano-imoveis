...
const STORAGE_KEY = "bebiano-admin:clientes-buscas-recentes"

type Suggestion = { id: string; name: string; phone: string; code: string }
...
export function ClientSearch() {
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      suggestClients(value).then(setSuggestions)
    }, 200)
    ...
    <div ref={containerRef} className="relative w-full max-w-sm">
      <div className="relative">
        ...
        <input
          ...
          placeholder="Buscar por nome, CPF, telefone, e-mail, cidade, código…"
