...
import { updateClientInteraction, deleteClientInteraction } from "@/modules/client/actions"
...
export function ClientInteractionList({
  clientId,
  interactions,
  emptyMessage = "Nenhuma interação registrada ainda.",
  onSuccess,
}: {
  clientId: string
  interactions: ClientDetail["interactions"]
  emptyMessage?: string
  // Painéis que buscam o cliente pra um estado local (ex: o Sheet de
  ...
  function saveEdit(id: string) {
    startTransition(async () => {
      try {
        await updateClientInteraction(clientId, id, draft)
  ...
  function handleDelete(id: string) {
    startTransition(async () => {
      try {
        await deleteClientInteraction(clientId, id)
