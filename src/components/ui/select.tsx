  ...
  return (
    <SelectPrimitive.Portal>
      ...
      <SelectPrimitive.Content
        ...
        align={align}
        className={cn(
          "relative z-50 max-h-(--radix-select-content-available-height) min-w-36 origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl border border-white/40 bg-popover/70 text-popover-foreground shadow-xl shadow-black/10 ring-1 ring-foreground/5 backdrop-blur-2xl backdrop-saturate-150 duration-[350ms] data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[align-trigger=true]:animate-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-open:blur-in data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-closed:blur-out dark:border-white/10 dark:bg-popover/60",
          position === "popper" &&
